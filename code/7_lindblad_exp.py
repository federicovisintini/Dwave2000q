...
from settings import DATA_DIR, STS11, HS11
...
with open(DATA_DIR / '7_115experiments_mean_spin.json', 'w') as f:
    json.dump(mean_spin_dict, f, indent=4)

with open(DATA_DIR / '7_115experiments_std_spin.json', 'w') as g:
